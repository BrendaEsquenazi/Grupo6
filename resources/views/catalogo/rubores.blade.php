...
<main class="py-5" style="background-color">
    <div class="container">
        <h1 class="text-center mb-2" style="font-family: 'Playfair Display'; font-weight: 700; letter-spacing: 2px;">RUBORES</h1>
        <p class="text-center text-muted mb-5" style="font-family">Un toque de color para un rostro lleno de vida</p>
        ...
        <div class="row g-4">
           ...
           <div class="col-6 col-md-4 col-lg-3">
            ...
            <div class="col-6 col-md-4 col-lg-3">
                <div class="card h-100 border-0 shadow-sm text-center">
                    <div class="p-3">
                        <img src="{{ asset('/img/Prod-Rubores/rubor7.webp') }}" class="img-fluid" alt="Rubor">
                    </div>
                    <div class="card-body">
